...
// Create a new job ManPower detail
// router.post('/', (req, res) => {
//   const { JobNo, ManPowerQty, TaskDate, BuyCost } = req.body;

//   // Define the SQL query to insert a new job ManPower detail
//   const sql = 'INSERT INTO tbNewJobManPowerDetails (JobNo, ManPowerQty, TaskDate, BuyCost) VALUES (?, ?, ?, ?)';

//   // Execute the SQL query to insert the ManPower detail data
//   db.query(sql, [JobNo, ManPowerQty, TaskDate, BuyCost], (err, result) => {
//     if (err) {
//       console.error('MySQL query error:', err);
//       res.status(500).json({ error: 'Internal Server Error' });
//     } else {
//       console.log('Job ManPower detail inserted:', result);
//       res.status(201).json({ message: 'Job ManPower detail inserted successfully' });
//     }
//   });
// });
